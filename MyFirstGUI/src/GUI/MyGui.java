...
//				Person p= new Person();
		...
		btnWritejason = new Button(shell, SWT.NONE);
		btnWritejason.addSelectionListener(new SelectionAdapter() {
			@Override
			public void widgetSelected(SelectionEvent e) {
				try {
					Mensch.Write2Jason();
		...
		btnWritejason.setBounds(187, 194, 90, 30);
		btnWritejason.setText("Write2Jason");
	...
	public Button getBtnWritejason() {
		return btnWritejason;
	}
}
